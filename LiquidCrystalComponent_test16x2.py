...
lcd = LiquidCrystalComponent(pin_rs=27, pin_rw=22, pin_e=26, d0=19, d1=13, d2=6, d3=5, d4=0, d5=0, d6=0, d7=0, pin_backlight=None, backlight_enabled=True, cols=16, rows=2, dotsize=8, auto_linebreaks=True)
